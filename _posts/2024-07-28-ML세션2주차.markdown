...
- 지도 학습 알고리즘
    - 타깃이 있고 정답을 맞히는 것 학습
    - 훈련 데이터: 입력(데이터) + 타깃(정답) <br>
        ex) 입력: 생선의 길이와 무게, 타깃: 도미 여부, 특성: 길이와 무게

- 비지도 학습 알고리즘
    - 타깃이 없고 데이터를 파악하거나 변형
...
- **샘플**
: 하나의 생선 데이터
![image](https://github.com/user-attachments/assets/06f1c61f-e666-4d63-890b-550473ef5df5)
...
![image](https://github.com/user-attachments/assets/ab3afebe-a339-4933-ad4d-a51757c08301)
...
```
![image](https://github.com/user-attachments/assets/2b87c264-4a1b-47fa-980f-0a69e38d9eca)
>> (49, 2)
...
: 일정한 간격의 정수 또는 실수 배열 생성
    - 기본 간격은 1
    - ex) `np.arange(1, 3, 0.2)` >>> [1., 1.2, 1.4, 1.6, 1.8, 2., 2.2, 2.4, 2.6, 2.8]
- **shuffle()**
: 주어진 배열을 랜덤하게 섞음
    - 다차원 배열일 경우 첫 번째 축에 대해서만 섞음
![image](https://github.com/user-attachments/assets/7dbc7969-3bac-4063-b94a-2bcb6db19206)
...
```
![image](https://github.com/user-attachments/assets/08dca6e9-a313-4907-aefb-07860a218ab7)

```python
# 타깃 데이터 만들기
fish_target = np.concatenate((np.ones(35), np.zeros(14)))
```
![image](https://github.com/user-attachments/assets/f45bf078-0404-459e-a41e-7f87c72a4138)

![image](https://github.com/user-attachments/assets/06c8cf1e-6df5-45bf-a702-a8ff67fa254a)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/69d07e67-6de4-4bc4-a36e-0d0d106fccdb)
