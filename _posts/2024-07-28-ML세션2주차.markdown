...
- 주피터: 대화식 프로그래밍 환경
- 텍스트 셀 <br>
    ![image](https://github.com/user-attachments/assets/0c188f69-347e-4752-8f5a-3299b776d359){: .left}
...
: 하나의 생선 데이터
    ...
    ![image](https://github.com/user-attachments/assets/06f1c61f-e666-4d63-890b-550473ef5df5){class="left"}
...
![image](https://github.com/user-attachments/assets/ab3afebe-a339-4933-ad4d-a51757c08301){class="left"}
...
:(샘플 수, 특성 수) 출력
    ...
    ![image](https://github.com/user-attachments/assets/2b87c264-4a1b-47fa-980f-0a69e38d9eca){class="left"}
...
: 주어진 배열을 랜덤하게 섞음
    ...
    ![image](https://github.com/user-attachments/assets/7dbc7969-3bac-4063-b94a-2bcb6db19206){class="left"}
...
![image](https://github.com/user-attachments/assets/c481ca6d-befd-48db-b8f4-9f4c6f15b112){class="left"}
...
plt.show()
```
![image](https://github.com/user-attachments/assets/69d07e67-6de4-4bc4-a36e-0d0d106fccdb){class="left"}

```python
print(train_input[indexes])
```
![image](https://github.com/user-attachments/assets/10aec6db-f2ff-4a75-aeaf-811d651422d9){class="left"}

```python
print(print(train_target[indexes]))
```
![image](https://github.com/user-attachments/assets/61451340-8f18-4e48-afd0-09d146222394){class="left"}
